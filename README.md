...
- [EdiJunior88/learncafe_Microsoft_C_Sharp](https://github.com/EdiJunior88/learncafe_Microsoft_C_Sharp) - O curso C# é desenvolvido no Visual Studio 2012 e contém 53 aulas, sendo 25 básicas e 28 avançadas. O curso te dará suporte para trabalhar com os códigos e comandos em C#, tanto voltado para linguagem em si quanto voltado para a área do Visual Studio (3 weeks ago / ⭐1)
- [EdiJunior88/Balta.io_Comecando_com_Angular](https://github.com/EdiJunior88/Balta.io_Comecando_com_Angular) - O curso aborda todos os conceitos fundamentais do Angular e, aprendendo os conceitos fundamentais, você poderá utilizá-los em todas as versões mais recentes do Framework. (3 weeks ago / ⭐0)
- [EdiJunior88/Aluratube_v2](https://github.com/EdiJunior88/Aluratube_v2) - Um projeto que simula um app do Youtube registrando o título e url de qualquer vídeo que podem ser adicionados à página principal. (3 weeks ago / ⭐2)
</div>
